...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISqsMessenger sqsMessenger;
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await sqsMessenger.SendMessageAsync(customer.ToCustomerCreateMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await sqsMessenger.SendMessageAsync(customer.ToCustomerUpdateMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await sqsMessenger.SendMessageAsync(new CustomerDeleted() { Id = id });
        }
