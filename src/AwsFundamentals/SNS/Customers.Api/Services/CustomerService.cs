...
public class CustomerService : ICustomerService
{
    ...
    private readonly ISnsMessenger sqsMessenger;
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await sqsMessenger.PublishMessageAsync(customer.ToCustomerCreateMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await sqsMessenger.PublishMessageAsync(customer.ToCustomerUpdateMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await sqsMessenger.PublishMessageAsync(new CustomerDeleted() { Id = id });
        }
