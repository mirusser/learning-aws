...
public class Function
{
    ...
    /// the AWS credentials will come from the IAM role associated 
    /// with the function and the AWS region will be set to the
    ...
    /// <summary>
    /// Constructs an instance with a preconfigured S3 client. 
    /// This can be used for testing outside of the Lambda environment.
    /// </summary>
    ...
    public async Task FunctionHandler(S3Event evnt, ILambdaContext context)
    {
        ...
        foreach (var record in eventRecords)
        {
            ...
            {
                context.Logger.LogError(@$"Error getting object {s3Event.Object.Key} 
                    from bucket {s3Event.Bucket.Name}. Make sure they exist and your bucket 
